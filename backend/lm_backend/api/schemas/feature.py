...
class FlatFeatureSchema(BaseModel):
    ...
    product_id: int = Field(
        ..., title="Product id of the feature", description="The product id of the feature."
    )
    product_name: str = Field(
        ..., title="Product name of the feature", description="The product name of the feature."
    )
    config_id: int = Field(
        ..., title="Configuration ID", description="The ID of the configuration that the feature belongs to."
    )
