...
For the agent to retrieve licenses information, set the path to the folder containing the license server utility binary.
For `FlexLM` and `RLM`, the paths should be set using the following environment variables:
```bash
